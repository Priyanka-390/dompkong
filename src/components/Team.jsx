...
const teams = [
  {
    head: "Jaylon Schleifer",
    para: "Carter Septimus",
    img: img1,
    head2: "@Jaylon Schleifer",
    para2: "Nearly two decades in Business",
    para3:
    ...
    svg1: (
      <>
        <svg
          ...
          viewBox="0 0 24 24"
          fill="none"
          className="drop-shadow-[0px_0px_4px_#FDDA60]"
        >
          <path
  ...
  {
    head: "Talan Passaquindici Arcand",
    para: "Jakob Ekstrom Bothman",
    img: img2,
    head2: "@Talan Passaquindici Arcand",
    para2: "Invester  & International Top Model",
    para3:
  ...
  {
    head: "Alfonso Franci",
    para: "Alfonso Dokidis",
    img: img3,
    head2: "@Alfonso Franci",
    para2: "Nearly two decades in Business",
    para3:
...
const Team = () => {
  const array = teams.map((e) => (
    <div className="overflow-x-clip">
      <div className="border-t border-solid border-[#FDDA60] lg:mt-12 md:mt-10 mt-5 shadow-[0px_0px_4px_1px_#fdda60]"></div>
        ...
        <div className="md:w-1/2 w-full px-3" data-aos="fade-right">
          ...
          <div className="flex md:justify-start justify-center">
            <img
              src={e.img}
              alt="1"
              className="rounded-[20px] border-solid md:text-start text-center  bottom-[3px] border-[#FDDA60] shadow-[0px_0px_20px_4px_#fdda60]"
            />
          </div>
        </div>
  ...
  return (
    <div>
      <div className="container max-w-[1140px] mx-auto px-3 lg:pt-[94px] md:pt-16 pt-10 overflow-x-clip">
        <h2 className="lg:text-[64px] md:text-[50px] text-[32px] font-azosans text-white md:pb-0 pb-4 font-normal md:leading-[108px] text-center ">
          Meet The Team
        </h2>
        {array}
      </div>
