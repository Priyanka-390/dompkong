...
import footermonk from "../assets/images/footermonk.png";
    ...
    <div className=" overflow-x-clip">
      {id === open ? (
        <div className="relative inline-block">
          <div className="w-[2px] h-[17px] mx-auto opacity-0  duration-300 rounded-sm bg-[#FDDA60] shadow-[0_0_2px1px#FDDA60] absolute left-[8px] top-[-7px]"></div>
...
const Faqaccordian = () => {
  ...
  return (
    <div className="lg:pt-36 md:pt-32 sm:pt-28 pt-10 relative z-20 overflow-x-clip">
      <div className="container max-w-[896px] px-3 mx-auto">
        <p className="text-center md:text-[64px] text-[40px] text-white font-azosans font-normal leading-[108%]">
          FAQs
        </p>
        <div
          className="lg:mt-[55px] md:pt-10 sm:pt-8 pt-4"
        ...
        >
          <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
            ...
            <AccordionBody className=" text-white font-Montserrat text-base font-normal leading-[25px] pt-[9px]">
        ...
        <div className="flex justify-center items-center flex-col">
          <img
            src={footermonk}
            alt="monk"
            className="lg:mt-[92px] md:mt-16 sm:mt-8 mt-3"
          />
          <div className="flex lg:gap-6 md:gap-4 gap-3 lg:pt-12 md:pt-8 pt-4">
            <a
      ...
      <div className="border-t border-solid border-white w-full ld:mt-7 md:mt-6 mt-4"></div>
      <div className="flex justify-center items-center">
        <p className="text-white text-base font-Montserrat font-normal pt-4 pb-5">
          © DomPKong {pika}
        </p>
      </div>
      <img
      ...
      />
      <div className="w-[132px] h-[132px] rounded-full bg-[#FDDA60] blur-[146px] absolute top-[30%] z-[-10] left-[2%]"></div>
      <div className="w-[247px] h-[247px] rounded-full bg-[#FDDA60] blur-[147px] absolute bottom-0 left-0 z-[-10]"></div>
    </div>
  );
};
